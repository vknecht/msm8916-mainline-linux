...
/* 8936 RPM SMD Power Domain performance levels */
#define RPM_REGULATOR_CORNER_RETENTION		1
#define RPM_REGULATOR_CORNER_SVS_KRAIT		2
#define RPM_REGULATOR_CORNER_SVS_SOC		3
#define RPM_REGULATOR_CORNER_NORMAL		4
#define RPM_REGULATOR_CORNER_TURBO		5
#define RPM_REGULATOR_CORNER_SUPER_TURBO	6
